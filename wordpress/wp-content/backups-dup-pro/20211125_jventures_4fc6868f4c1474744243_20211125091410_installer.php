...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20211125_jventures_4fc6868f4c1474744243_20211125091410_archive.zip';
    const ARCHIVE_SIZE       = '81792326';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '4fc6868-25091410';
    const VERSION            = '3.8.7';
