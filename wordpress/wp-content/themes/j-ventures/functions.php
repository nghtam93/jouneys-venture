...
function dntheme_scripts() {
    ...
    wp_enqueue_script('waypoints',get_theme_file_uri('/assets/libs/waypoints/jquery.waypoints.js'), array(), '', true );
    wp_enqueue_script('counterup',get_theme_file_uri('/assets/libs/counterup/jquery.counterup.min.js'), array(), '', true );
...
function get_post_loadmore() {
    $offset = isset($_GET['offset']) ? (int)$_GET['offset'] : 0; // lấy dữ liệu phái client gởi
    $catid = isset($_GET['catid']) ? (int)$_GET['catid'] : 0; // lấy dữ liệu phái client gởi
